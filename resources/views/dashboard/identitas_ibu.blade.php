                                    ...
                                    <tr>
                                        ...
                                        <td class="font-semibold text-center capitalize">
                                            <label for="lihat_modal_{{ $item->id_user }}"
                                                class="flex items-center justify-center w-full gap-2 font-bold text-white btn btn-neutral">
                                                <span>Lihat</span>
                                            </label>
                                                    ...
                                                    <div
                                                        ...
                                                        @if ($item->user->foto_profil === null)
                                                            <img id="foto_profil_preview_{{ $item->id_user }}"
                                                                ...
                                                                class="border size-full" alt="{{ $item->user->nama }}">
                                                        @else
                                                            <img id="foto_profil_preview_{{ $item->id_user }}"
                                                        ...
                                                        <form action="{{ route('photo.update', $item->id_user) }}"
                                                            ...
                                                            <button type="submit"
                                                                class="w-full mt-3 cursor-pointer btn btn-sm btn-accent">Simpan</button>
                                                        </form>
                                                    </div>
                                                </div>
                                            ...
                                            <dialog id="detail_modal_{{ $item->id_user }}"
                                                ...
                                                <div
                                                    ...
                                                    <div class="flex items-center justify-between mb-6">
                                                        ...
                                                        <button
                                                            class="transition-colors btn btn-sm btn-circle btn-neutral hover:bg-red-500 hover:text-white"
                                                    ...
                                                    <div class="overflow-x-auto">
                                                        <table
                                                            class="min-w-full text-sm text-left bg-white border-separate border-spacing-y-2">
                                                            <thead>
                                                    ...
                                                    <div class="flex justify-between mt-6 modal-action">
                                                        <button
                                                            class="px-6 py-3 text-white transition-all bg-pink-500 rounded-md shadow-md btn hover:bg-pink-600"
                                                            onclick="document.getElementById('detail_modal_{{ $item->id_user }}').close();">
                                                            Tutup
                                                        </button>
                                                        <button
                                                            class="px-6 py-3 text-white transition-all bg-gray-500 rounded-md shadow-md btn hover:bg-gray-600"
                                                    ...
                                                    <div class="modal-box bg-base-100">
                                                        ...
                                                        <div class="mt-3">
                                                            <p class="font-semibold text-red-800">Perhatian! Anda
                                                                ...
                                                                <strong
                                                                    class="font-bold text-red-800">{{ $item->user->nama }}</strong>.
                                                        ...
                                                        <div class="modal-action">
                                                            ...
                                                            <form
                                                                action="{{ route('delete.pengguna', $item->id_user) }}"
