          ...
          <div class="p-5 bg-white sm:p-7 rounded-t-xl">
            <div class="flex items-center">
              ...
              <div class="flex ml-auto gap-3">
                <label for="add_data_PELAYANAN_DOKTER_EVALUASI_v1" class="btn">Tambah Data v1</label>
                <label for="add_data_PELAYANAN_DOKTER_EVALUASI_v2" class="btn">Tambah Data v2</label>
              </div>
            </div>
