 <x-dashboard.main title="Informasi 4 - 5 Tahun">
   @foreach (['Daftar_informasi_4_-_5_Tahun'] as $item)
     <div class="flex flex-col border-back rounded-xl w-full">
       <div class="p-5 sm:p-7 bg-white rounded-t-xl">
         ...
         <p class="text-sm opacity-60">
           Jelajahi dan ketahui Informasi seputar 4 - 5 Tahun.
         </p>
       </div>
 ...
 <script async>
   ...
   window.onload = async () => await loadSurat({
     api: '/images/informasi/anak/anak_45tahun/data.json',
     pdfUrl: '/images/informasi/anak/anak_45tahun',
     container
   })
 </script>
