...
<<<<<<< HEAD
              ...
              <div class="flex ml-auto gap-3">
                <label for="add_data_PELAYANAN_DOKTER_v1" onclick="tambahData({{ $item }})" class="btn">Tambah Data v1</label>
...
=======
                            ...
                            <div class="flex ml-auto gap-3">
                                <label for="add_data_PELAYANAN_DOKTER_v1" onclick="tambahData({{ $item }})"
                                    class="btn">Tambah Data v1</label>
                                <label for="add_data_PELAYANAN_DOKTER_v2" class="btn">Tambah Data v2</label>
                            </div>
                        </div>
                        <p class="text-sm opacity-60">
...
<div class="modal" role="dialog" id="PELAYANAN_DOKTER">
    <form onsubmit="setupFormGenerate(this, 'PELAYANAN_DOKTER', 'bkiabi-pelayanan-dokter.pdf')"
